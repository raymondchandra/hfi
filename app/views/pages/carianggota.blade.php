...
<script>
	...
	$('body').on('click','#tombol_cari', function(){
		...
		var url = '{{ URL::route('getDaftarAnggota')}}';
		$.ajax({				
			url: url,
			type: 'GET',
			data: {
			...
			success: function(data){							
				...
				for($i=0; $i<length; $i++){	
						...
						//end simpan arrlist
					list+="<tr>";
						list+="<td style='vertical-align:middle !important; width:220px; overflow:hidden;'>"+data[$i]['nama']+"</td>";
						list+="<td style='vertical-align:middle !important; width:220px;'>"+data[$i]['no_anggota']+"</td>";
					...
					<div>
						<table class="tabel_cari" border="0" style="margin-top:30px;">
							...
							<tr>
								...
								<td>
									<?php 
										$arrtempcabang = array('0' => 'pilih!');
										foreach($listcabang as $value){
											$arrtempcabang[$value] = $value;
										}								
									?>
